...
namespace KKShop.Web.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        {
            ViewBag.Title = data.CategoryID == 0 ? "Bổ sung loại hàng" : "Cập nhật thông tin loại hàng";
            ...
            if (data.CategoryID == 0)
            {
                ...
                if (id <= 0)
                {
                    ModelState.AddModelError(nameof(data.CategoryName), "Tên loại hàng bị trùng");
                    return View("Edit", data);
                }
            }
            else
