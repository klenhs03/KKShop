...
namespace KKShop.Shop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> LoginAsync(string username, string password)
        {
            ...
            //TODO: Kiểm tra xe username và password (của Customer) có đúng không?
            var userAccount = UserAccountService.Authorise(UserTypes.Customer, username, password);
            if (userAccount == null)
            {
        ...
        public IActionResult Information(int id = 0)
        {
